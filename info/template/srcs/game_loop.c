...
/*   Updated: 2025/07/05 00:02:15 by avieira-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	update(t_cub *cub)
{
	...
	if (cub->player.direction.x != 0)
		...
		cub->player.velocity.x += cub->player.direction.x * 0.3 * cub->delta;

	if (cub->player.velocity.x < 0.2 && cub->player.velocity.x > -0.2)
